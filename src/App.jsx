...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['inicio', 'historia', 'proceso', 'roadmap'];
  ...
  return (
    <div className={theme === 'light' ? 'light-theme' : 'dark-theme'} style={styles.appWrapper}>
      ...
      <div style={styles.dashboardCard} className="metal-panel">
      ...
      <footer style={styles.footer}>
        <div style={styles.footerGrid}>
          ...
          <div style={styles.warningLine} className="warning-stripes" />
